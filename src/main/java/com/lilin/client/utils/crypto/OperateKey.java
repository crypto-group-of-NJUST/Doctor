...
public class OperateKey {
    ...
    public static void genSM2ClientKeyToFile() {
        try {
            ...
            FileUtil.writeFile("/Users/lilin/Desktop/Doctor/SM2KeyPair/ec.pkcs8.pri.der", keyPair.get("private"));
            FileUtil.writeFile("/Users/lilin/Desktop/Doctor/SM2KeyPair/ec.x509.pub.der", keyPair.get("public"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
